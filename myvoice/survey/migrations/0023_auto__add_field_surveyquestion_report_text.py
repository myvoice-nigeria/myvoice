...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SurveyQuestion.report_text'
        db.add_column(u'survey_surveyquestion', 'report_text',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SurveyQuestion.report_text'
        db.delete_column(u'survey_surveyquestion', 'report_text')
    ...
    models = {
        ...
        u'survey.surveyquestion': {
            ...
            'report_text': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
