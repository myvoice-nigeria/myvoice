...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SurveyQuestionResponse.display_on_dashboard'
        db.add_column(u'survey_surveyquestionresponse', 'display_on_dashboard',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SurveyQuestionResponse.display_on_dashboard'
        db.delete_column(u'survey_surveyquestionresponse', 'display_on_dashboard')
