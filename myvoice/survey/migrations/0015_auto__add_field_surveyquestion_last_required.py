...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SurveyQuestion.last_required'
        db.add_column(u'survey_surveyquestion', 'last_required',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SurveyQuestion.last_required'
        db.delete_column(u'survey_surveyquestion', 'last_required')
