...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DisplayLabel'
        db.create_table(u'survey_displaylabel', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200)),
        ))
        db.send_create_signal(u'survey', ['DisplayLabel'])

        # Adding field 'SurveyQuestion.display_label'
        db.add_column(u'survey_surveyquestion', 'display_label',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['survey.DisplayLabel'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'DisplayLabel'
        db.delete_table(u'survey_displaylabel')

        # Deleting field 'SurveyQuestion.display_label'
        db.delete_column(u'survey_surveyquestion', 'display_label_id')
