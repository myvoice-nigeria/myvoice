...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SurveyQuestion.for_satisfaction'
        db.add_column(u'survey_surveyquestion', 'for_satisfaction',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SurveyQuestion.for_satisfaction'
        db.delete_column(u'survey_surveyquestion', 'for_satisfaction')
