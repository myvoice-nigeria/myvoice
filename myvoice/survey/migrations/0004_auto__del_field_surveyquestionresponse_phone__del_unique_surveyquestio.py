...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'SurveyQuestionResponse', fields ['visit', 'question']
        db.create_unique(u'survey_surveyquestionresponse', ['visit_id', 'question_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'SurveyQuestionResponse', fields ['visit', 'question']
        db.delete_unique(u'survey_surveyquestionresponse', ['visit_id', 'question_id'])

        # Adding field 'SurveyQuestionResponse.phone'
        db.add_column(u'survey_surveyquestionresponse', 'phone',
                      self.gf('django.db.models.fields.CharField')(default='12345678901', max_length=32),
                      keep_default=False)
