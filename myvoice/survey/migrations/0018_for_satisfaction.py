...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        labels = ['Respectful Staff Treatment', 'Charged Fairly', 'Wait Time']
        for question in orm.SurveyQuestion.objects.filter(label__in=labels):
            question.for_satisfaction = True
            question.save()

    def backwards(self, orm):
        "Write your backwards methods here."
        for question in orm.SurveyQuestion.objects.all():
            question.for_satisfaction = False
            question.save()
