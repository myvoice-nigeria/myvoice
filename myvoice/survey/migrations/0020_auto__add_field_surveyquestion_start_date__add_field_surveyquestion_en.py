...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'survey_surveyquestion', 'start_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'SurveyQuestion.end_date'
        db.add_column(u'survey_surveyquestion', 'end_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SurveyQuestion.start_date'
        db.delete_column(u'survey_surveyquestion', 'start_date')

        # Deleting field 'SurveyQuestion.end_date'
        db.delete_column(u'survey_surveyquestion', 'end_date')
