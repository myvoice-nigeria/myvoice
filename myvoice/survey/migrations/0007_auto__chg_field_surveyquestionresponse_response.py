...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'survey_surveyquestionresponse', 'response', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):

        # Changing field 'SurveyQuestionResponse.response'
        db.alter_column(u'survey_surveyquestionresponse', 'response', self.gf('django.db.models.fields.CharField')(max_length=255))
