...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'survey_surveyquestion', 'for_display')

        # Deleting field 'SurveyQuestion.designation'
        db.delete_column(u'survey_surveyquestion', 'designation')

        # Deleting field 'SurveyQuestion.order'
        db.delete_column(u'survey_surveyquestion', 'order')


    def backwards(self, orm):
        # Adding field 'SurveyQuestion.for_display'
        db.add_column(u'survey_surveyquestion', 'for_display',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'SurveyQuestion.designation'
        db.add_column(u'survey_surveyquestion', 'designation',
                      self.gf('django.db.models.fields.CharField')(default='unknown', max_length=8),
                      keep_default=False)

        # Adding field 'SurveyQuestion.order'
        db.add_column(u'survey_surveyquestion', 'order',
