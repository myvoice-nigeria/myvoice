...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ManualRegistration'
        db.create_table(u'clinics_manualregistration', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('entry_date', self.gf('django.db.models.fields.DateField')(default=datetime.date.today)),
            ('visit_count', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('clinic', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['clinics.Clinic'])),
        ))
        db.send_create_signal(u'clinics', ['ManualRegistration'])

        # Adding unique constraint on 'ManualRegistration', fields ['entry_date', 'clinic']
        db.create_unique(u'clinics_manualregistration', ['entry_date', 'clinic_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'ManualRegistration', fields ['entry_date', 'clinic']
        db.delete_unique(u'clinics_manualregistration', ['entry_date', 'clinic_id'])

        # Deleting model 'ManualRegistration'
        db.delete_table(u'clinics_manualregistration')
    ...
    models = {
        ...
        u'clinics.clinic': {
            'Meta': {'ordering': "['name']", 'object_name': 'Clinic'},
        ...
        u'clinics.manualregistration': {
            'Meta': {'unique_together': "(('entry_date', 'clinic'),)", 'object_name': 'ManualRegistration'},
            'clinic': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['clinics.Clinic']"}),
            'entry_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date.today'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'visit_count': ('django.db.models.fields.PositiveIntegerField', [], {})
        },
        u'clinics.patient': {
