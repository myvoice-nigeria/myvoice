...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'clinics_patient', (
        ...
        db.send_create_signal(u'clinics', ['Patient'])

        # Adding model 'Visit'
        db.create_table(u'clinics_visit', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('patient', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['clinics.Patient'])),
            ('service_type', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('staff', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['clinics.ClinicStaff'], null=True, blank=True)),
            ('visit_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'clinics', ['Visit'])


    def backwards(self, orm):
        # Deleting model 'Patient'
        db.delete_table(u'clinics_patient')

        # Deleting model 'Visit'
        db.delete_table(u'clinics_visit')
