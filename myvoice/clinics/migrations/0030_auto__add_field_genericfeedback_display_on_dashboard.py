...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GenericFeedback.display_on_dashboard'
        db.add_column(u'clinics_genericfeedback', 'display_on_dashboard',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'GenericFeedback.display_on_dashboard'
        db.delete_column(u'clinics_genericfeedback', 'display_on_dashboard')
