...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'VisitRegistrationError.error_count'
        db.delete_column(u'clinics_visitregistrationerror', 'error_count')


    def backwards(self, orm):
        # Adding field 'VisitRegistrationError.error_count'
        db.add_column(u'clinics_visitregistrationerror', 'error_count',
