...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Visit.visit_time'
        db.alter_column(u'clinics_visit', 'visit_time', self.gf('django.db.models.fields.DateTimeField')())

    def backwards(self, orm):

        # Changing field 'Visit.visit_time'
        db.alter_column(u'clinics_visit', 'visit_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))
