...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'State'
        db.create_table(u'clinics_state', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal(u'clinics', ['State'])

        # Adding model 'LGA'
        db.create_table(u'clinics_lga', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('state', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['clinics.State'])),
        ))
        db.send_create_signal(u'clinics', ['LGA'])


    def backwards(self, orm):
        # Deleting model 'State'
        db.delete_table(u'clinics_state')

        # Deleting model 'LGA'
        db.delete_table(u'clinics_lga')
