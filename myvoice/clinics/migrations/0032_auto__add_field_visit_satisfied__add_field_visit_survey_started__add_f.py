...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'clinics_visit', 'satisfied',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Visit.survey_started'
        db.add_column(u'clinics_visit', 'survey_started',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Visit.survey_completed'
        db.add_column(u'clinics_visit', 'survey_completed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Visit.satisfied'
        db.delete_column(u'clinics_visit', 'satisfied')

        # Deleting field 'Visit.survey_started'
        db.delete_column(u'clinics_visit', 'survey_started')

        # Deleting field 'Visit.survey_completed'
        db.delete_column(u'clinics_visit', 'survey_completed')
