...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Patient.serial'
        db.add_column(u'clinics_patient', 'serial',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Clinic.code'
        db.add_column(u'clinics_clinic', 'code',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Patient.serial'
        db.delete_column(u'clinics_patient', 'serial')

        # Deleting field 'Clinic.code'
        db.delete_column(u'clinics_clinic', 'code')
