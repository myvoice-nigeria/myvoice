...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Visit.service_type'
        db.delete_column(u'clinics_visit', 'service_type')

        # Adding field 'Visit.service'
        db.add_column(u'clinics_visit', 'service',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['clinics.Service']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Visit.service_type'
        db.add_column(u'clinics_visit', 'service_type',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=50),
                      keep_default=False)

        # Deleting field 'Visit.service'
        db.delete_column(u'clinics_visit', 'service_id')
