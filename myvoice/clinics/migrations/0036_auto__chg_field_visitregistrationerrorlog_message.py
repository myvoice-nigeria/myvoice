...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'VisitRegistrationErrorLog.message'
        db.alter_column(u'clinics_visitregistrationerrorlog', 'message', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):

        # Changing field 'VisitRegistrationErrorLog.message'
        db.alter_column(u'clinics_visitregistrationerrorlog', 'message', self.gf('django.db.models.fields.CharField')(max_length=160))
