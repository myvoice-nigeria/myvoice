...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'clinics_visitregistrationerror', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sender', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('error_type', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('error_count', self.gf('django.db.models.fields.PositiveIntegerField')()),
        ))
        db.send_create_signal(u'clinics', ['VisitRegistrationError'])

        # Adding model 'VisitRegistrationErrorLog'
        db.create_table(u'clinics_visitregistrationerrorlog', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sender', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('error_type', self.gf('django.db.models.fields.PositiveIntegerField')()),
        ...
        db.send_create_signal(u'clinics', ['VisitRegistrationErrorLog'])


    def backwards(self, orm):
        # Deleting model 'VisitRegistrationError'
        db.delete_table(u'clinics_visitregistrationerror')

        # Deleting model 'VisitRegistrationErrorLog'
        db.delete_table(u'clinics_visitregistrationerrorlog')
    ...
    models = {
        ...
        u'clinics.visit': {
            ...
            'service': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['clinics.Service']"}),
