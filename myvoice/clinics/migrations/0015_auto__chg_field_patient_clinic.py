...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Patient.clinic'
        db.alter_column(u'clinics_patient', 'clinic_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['clinics.Clinic'], null=True))

    def backwards(self, orm):

        # Changing field 'Patient.clinic'
        db.alter_column(u'clinics_patient', 'clinic_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['clinics.Clinic']))
