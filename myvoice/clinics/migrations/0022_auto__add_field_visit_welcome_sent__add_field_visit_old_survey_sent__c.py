...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_column(u'clinics_visit', 'survey_sent', 'old_survey_sent')
        db.add_column(u'clinics_visit', 'welcome_sent',
    ...
    def backwards(self, orm):
        db.delete_column(u'clinics_visit', 'welcome_sent')
        db.delete_column(u'clinics_visit', 'survey_sent')
        db.rename_column(u'clinics_visit', 'old_survey_sent', 'survey_sent')
    ...
    models = {
        ...
        u'clinics.visit': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'old_survey_sent': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
