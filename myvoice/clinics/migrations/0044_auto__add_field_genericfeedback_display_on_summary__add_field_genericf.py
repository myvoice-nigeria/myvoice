...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'clinics_genericfeedback', 'display_on_summary',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'GenericFeedback.report_count'
        db.add_column(u'clinics_genericfeedback', 'report_count',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'GenericFeedback.display_on_summary'
        db.delete_column(u'clinics_genericfeedback', 'display_on_summary')

        # Deleting field 'GenericFeedback.report_count'
        db.delete_column(u'clinics_genericfeedback', 'report_count')
