...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_unique(u'clinics_service', ['code'])

        # Deleting field 'Patient.contact'
        db.delete_column(u'clinics_patient', 'contact_id')

        # Deleting field 'Clinic.category'
        db.delete_column(u'clinics_clinic', 'category')

        # Deleting field 'Clinic.contact'
        db.delete_column(u'clinics_clinic', 'contact_id')

        # Deleting field 'Clinic.year_opened'
        db.delete_column(u'clinics_clinic', 'year_opened')

        # Deleting field 'Clinic.last_renovated'
        db.delete_column(u'clinics_clinic', 'last_renovated')


    def backwards(self, orm):
        # Removing unique constraint on 'Service', fields ['code']
        db.delete_unique(u'clinics_service', ['code'])

        # Adding field 'Patient.contact'
        db.add_column(u'clinics_patient', 'contact',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rapidsms.Contact'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Clinic.category'
        db.add_column(u'clinics_clinic', 'category',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=32, blank=True),
                      keep_default=False)

        # Adding field 'Clinic.contact'
        db.add_column(u'clinics_clinic', 'contact',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rapidsms.Contact'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Clinic.year_opened'
        db.add_column(u'clinics_clinic', 'year_opened',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=4, blank=True),
                      keep_default=False)

        # Adding field 'Clinic.last_renovated'
        db.add_column(u'clinics_clinic', 'last_renovated',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=4, blank=True),
                      keep_default=False)
