...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Clinic.type'
        db.add_column(u'clinics_clinic', 'type',
                      self.gf('django.db.models.fields.CharField')(default='primary', max_length=16, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Clinic.type'
        db.delete_column(u'clinics_clinic', 'type')
